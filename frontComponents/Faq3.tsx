...
const Faq2 = ({dictionary}:{dictionary:any}) => {
  return (
    ...
    <div className=" bg-white "id="accordion-collapse" data-accordion="open">
      ...
      <div id="accordion-collapse-body-5" className="hidden" aria-labelledby="accordion-collapse-heading-5">
        <div className="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col  ">
                <Image className="rounded items-center text-center mx-auto md:block sm:hidden" src = {cheves} alt="/" width="600" height="50" priority={true} />
                <p className="text-center text-[24px] p-3 md:block sm:hidden">Attorney William Cheves</p>
          </div>
